...
日替わりの修行、ステージ制のチャレンジ任務、誘惑ジャッジ、4つのモード、プレイ中に出る緊急イベント、押さないための行動、冷静ポイント、対処コンボ、緊張ゲージ、実績、称号、最近の挑戦履歴を収録しています。
...
Guideline 4.2対応として、単一ボタンだけの体験から、状況を読んで3択で答える誘惑ジャッジ、日替わり修行、ステージ制チャレンジ任務、プレイ中の緊急イベント、押さないための行動、冷静ポイント、イベント対処コンボ、任務の達成状況、称号、実績、最近の挑戦履歴を含むゲーム体験に拡張しました。Guideline 2.3.3対応として、スクリーンショットはCI上のiOSシミュレーターで実アプリを起動して撮影する形に変更しました。
