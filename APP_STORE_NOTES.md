...
20本のチャレンジ任務、24枚の誘惑ジャッジ、16種類の緊急イベント、攻略メモ、日替わり修行、4つのモード、押さないための行動、冷静ポイント、対処コンボ、緊張ゲージ、16個の実績、称号、最近の挑戦履歴を収録しています。
...
Guideline 4.2対応として、単一ボタンだけの体験から、20本のステージ制チャレンジ任務、24枚の3択誘惑ジャッジ、16種類の緊急イベント、攻略メモ、日替わり修行、押さないための行動、冷静ポイント、イベント対処コンボ、任務の達成状況、称号、16個の実績、最近の挑戦履歴を含むゲーム体験に拡張しました。起動直後に収録数が分かる「遊べる内容」パネルも追加しています。Guideline 2.3.3対応として、スクリーンショットはCI上のiOSシミュレーターで実アプリを起動して撮影する形に変更しました。
